...
export default function PBQuizInstruction(){
    ...
    return(
        <div className='MainContainer1'>
            ...
            <br/><br/>The computerized portion of this system is self-guided and self-paced.  You are free to work at your own pace.  Start with Step 1 to register.  Each time you finish a section you will come back to this menu to continue with the next step.  You will be asked to enter your ID number as you begin each section.
            </p>
